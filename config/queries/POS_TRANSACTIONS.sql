...
SELECT header.id, location.address_country, location.kepler_store_name, location.location_id, header.sale_datetime, header.new_customer, line_items.sku, line_items.is_aftercare, line_items.is_piercing, line_items.is_service, line_items.total_price_inc_tax, line_items.total_price
